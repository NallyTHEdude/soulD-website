...
export default function CustomProposalSection() {
  ...
  return (
    <section id="custom-proposal" className="relative z-10 bg-[#090b14] text-white py-20 lg:py-28 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          <div className="lg:col-span-5">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-400/20 text-indigo-200 text-xs font-bold tracking-widest uppercase mb-6">
            ...
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-xl mb-8">
              Share your project goals and our team will shape a practical proposal with the right services, timeline, and budget range for your brand.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-3">
              <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white mb-1">Tailored Scope</h3>
                  <p className="text-xs leading-relaxed text-slate-400">Services mapped to your stage, goals, and budget.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                ...
                <div>
                  ...
                  <p className="text-xs leading-relaxed text-slate-400">Expect a response within 2 to 4 business hours.</p>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white text-slate-900 p-6 sm:p-8 lg:p-10 shadow-2xl shadow-black/30">
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-extrabold text-slate-900 mb-3">Proposal Request Received</h3>
                  <p className="text-sm text-slate-600 leading-relaxed max-w-md mx-auto mb-6">
                    Thank you{formData.name ? `, ${formData.name}` : ''}. Soul-D. will review your requirements and contact you at {formData.email || formData.phone}.
                  </p>
                  <button
                    type="button"
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Tell us what you need and we will prepare a clear next-step plan.</p>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="proposal-name" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Full Name *
                      </label>
                      <input
                        id="proposal-name"
                    ...
                    <div>
                      <label htmlFor="proposal-email" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Email Address *
                      </label>
                      <input
                        id="proposal-email"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="proposal-phone" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Phone Number *
                      </label>
                    ...
                    <div>
                      <label htmlFor="proposal-company" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Company / Brand
                      </label>
                      <input
                        id="proposal-company"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="sm:col-span-1">
                      <label htmlFor="proposal-service" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Service *
                      </label>
                      <select
                        id="proposal-service"
                    ...
                    <div>
                      <label htmlFor="proposal-budget" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Budget
                      </label>
                      <select
                        id="proposal-budget"
                    ...
                    <div>
                      <label htmlFor="proposal-timeline" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Timeline
                      </label>
                      <select
                  ...
                  <div>
                    <label htmlFor="proposal-message" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                      Project Goals *
                    </label>
                    <textarea
                      id="proposal-message"
                  ...
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-sm py-4 shadow-lg shadow-indigo-600/25 transition-all"
                  >
